...
import { Download, FileText, Award, Briefcase, GraduationCap, ExternalLink, Upload } from "lucide-react"
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-700 to-purple-800 rounded-2xl p-8 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                ...
                {isDownloading ? "Đang tải..." : "Download Resume (PDF)"}
              </Button>
            ...
            <div className="mt-6 text-center">
              <p className="text-purple-200 text-sm">📄 Complete Resume • Professional Format • Ready to Download</p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-800 mb-2">📋 Để tải xuống hoạt động</h4>
                <div className="text-blue-700 space-y-2 text-sm">
                  <p>
                    <strong>1.</strong> Tải code về máy: Click{" "}
                    <span className="bg-blue-100 px-2 py-1 rounded font-mono">"Download Code"</span> ở góc phải trên
                  </p>
                  <p>
                    <strong>2.</strong> Tạo file PDF từ nội dung resume đã cung cấp
                  </p>
                  <p>
                    <strong>3.</strong> Đặt file PDF vào:{" "}
                    <span className="bg-blue-100 px-2 py-1 rounded font-mono">public/resume/thao-dinh-resume.pdf</span>
                  </p>
                  <p>
                    <strong>4.</strong> Deploy lại website
                  </p>
                  <p className="text-green-700 font-medium">✅ Sau đó nút Download sẽ tải về file PDF gốc của bạn!</p>
                </div>
              </div>
            </div>
          </div>
